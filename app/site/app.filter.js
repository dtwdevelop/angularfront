...
var Filter = (function () {
    ...
    Filter.prototype.transform = function (value, args) {
        if (!args[0]) {
            return value;
        }
        else if (value) {
        ...
        if (!Array.isArray(config) || (Array.isArray(config) && config.length == 1)) {
            ...
            if (!propertyToCheck || propertyToCheck == '-' || propertyToCheck == '+') {
                ...
                return input.sort(function (a, b) {
                    return !desc ? OrderBy_1._orderByComparator(a[property], b[property]) : OrderBy_1._orderByComparator(a[property], b[property]);
                });
            }
        }
        else {
            ...
            return input.sort(function (a, b) {
                for (var i = 0; i < config.length; i++) {
                    ...
                    var comparison = !desc ? OrderBy_1._orderByComparator(a[property], b[property]) : OrderBy_1._orderByComparator(a[property], b[property]);
